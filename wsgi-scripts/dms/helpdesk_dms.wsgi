...
class JsonRpcContainer(BaseJsonRpcContainer):
    ...
    def list_zone(self, **kwargs):
        return self._engine.list_zone_helpdesk(**kwargs)
    ...
    def load_zone(self, **kwargs):
        return self._engine.load_zone_helpdesk(**kwargs)

    def load_zi(self, **kwargs):
        return self._engine.load_zi_helpdesk(**kwargs)

    def delete_zone(self, **kwargs):
        return self._engine.delete_zone_helpdesk(**kwargs)
    
    def set_zone(self, **kwargs):
        return self._engine.set_zone_helpdesk(**kwargs)
    ...
    def copy_zone(self, **kwargs):
        return self._engine.copy_zone_helpdesk(**kwargs)
    ...
    def update_zone_text(self, **kwargs):
        return self._engine.update_zone_text_helpdesk(**kwargs)
    ...
    def update_rrs(self, **kwargs):
        return self._engine.update_rrs_helpdesk(**kwargs)
